      ...
      >
        ...
        <View style={s.recentCard}>
          ...
          {recentRecords.length === 0 && (
            <Text style={s.noData}>No records yet</Text>
          )}
          ...
          {recentRecords.map((item, i) => (
            <View key={item._id || i} style={s.recentItem}>
              <View style={{ flex: 1 }}>
                ...
                <Text style={s.recentMeta}>{item.age} yrs • {item.gender}</Text>
              </View>
...
const s = StyleSheet.create({
  ...
  statCard: {
    ...
    padding: 16, borderWidth: 1, borderColor: "#f0e6ff",
  },
  ...
  chartCard: {
    ...
    marginBottom: 20, borderWidth: 1, borderColor: "#f0e6ff",
  },
  ...
  recentItem: {
    flexDirection: "row", justifyContent: "space-between", alignItems: "center",
    paddingVertical: 12, borderBottomWidth: 0.5, borderBottomColor: "#f0e6ff",
  },
  ...
  newBtn: {
    backgroundColor: C.purple, flexDirection: "row", alignItems: "center",
    justifyContent: "center", padding: 18, borderRadius: 18,
    gap: 10, marginTop: 20,
  },
